...
namespace ECommerce1.Models
{
    ...
    {
            public async Task<byte[]> GeraQrCode(string dadosBanco)
            {
                QRCodeGenerator qrCodeGenerator = new QRCodeGenerator();
                 
                QRCodeData qrCodeData = qrCodeGenerator.CreateQrCode(dadosBanco, QRCodeGenerator.ECCLevel.Q);
            ...
            public async Task<IActionResult> Download(CompraUsuario compraUsuario, IWebHostEnvironment _webHostEnvironment)
            {
